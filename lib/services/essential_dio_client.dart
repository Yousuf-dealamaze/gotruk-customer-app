...
class EssentialDioClientService {
  final dio = createDio();
  final navigatorKey = GlobalKey<NavigatorState>();
  static const excludeErrorUrl = ["user/delivery_addresses"];

  EssentialDioClientService._internal();
  static final _singleton = EssentialDioClientService._internal();

  factory EssentialDioClientService() => _singleton;

  static Dio createDio() {
    var dio = Dio(BaseOptions(baseUrl: Constant.essentialPrefix));
